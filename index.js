...
J:   [
    ['J1', '无主线（纯自由剧情）'],
    ['J2', '单主线·卡利亚异常调查（永恒欢愉入口）'],
    ['J3', '单主线·失落旗舰传说（帝皇幻梦号入口）'],
    ['J4', '单主线·太平潮涌（迷宫建造者入口）'],
    ['J5', '单主线·圣机之蚀（机械神教异常入口）'],
    ['J6', '双主线·卡利亚异常调查 + 失落旗舰传说'],
    ['J7', '双主线·卡利亚异常调查 + 太平潮涌'],
    ['J8', '双主线·卡利亚异常调查 + 圣机之蚀'],
    ['J9', '双主线·失落旗舰传说 + 太平潮涌'],
    ['J10', '双主线·失落旗舰传说 + 圣机之蚀'],
    ['J11', '双主线·太平潮涌 + 圣机之蚀'],
    ['J12', '三主线·卡利亚异常调查 + 失落旗舰传说 + 太平潮涌'],
    ['J13', '三主线·卡利亚异常调查 + 失落旗舰传说 + 圣机之蚀'],
    ['J14', '三主线·卡利亚异常调查 + 太平潮涌 + 圣机之蚀'],
    ['J15', '三主线·失落旗舰传说 + 太平潮涌 + 圣机之蚀'],

    ['J16', '四主线全开（极高负荷 / 史诗长跑模式）'],
  ],
  K: [
    ['K1', '身无长物'],
    ['K2', '基本温饱'],
